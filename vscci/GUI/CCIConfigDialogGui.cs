    ...
    public class CCIConfigDialogGui : GuiDialog
    {
        ...
        public override void OnOwnPlayerDataReceived()
        {
            ...
            SingleComposer = capi.Gui.CreateCompo("cciconfig", dialogBounds)
                ...
                .AddDynamicText(userName, CairoFont.WhiteSmallText().WithFontSize(10), twitchUserNameBoundsDyn, TWITCH_USER_KEY)
                .AddStaticText("Twitch ID: ", CairoFont.WhiteSmallText().WithFontSize(10), twitchUserIdBounds)
                .AddDynamicText(id, CairoFont.WhiteSmallText().WithFontSize(10), twitchUserIdBoundsDyn, TWITCH_ID_KEY)
                .AddStaticText("Twitch Status: ", CairoFont.WhiteSmallText().WithFontSize(10), twitchStatusBounds)
                .AddDynamicText(status, CairoFont.WhiteSmallText().WithFontSize(10), twitchStatusBoundsDyn, TWITCH_STATUS_KEY)
                ...
                .AddDynamicText(slStatus, CairoFont.WhiteSmallText().WithFontSize(10), streamPlatformStatusBoundsDyn, STREAMLABS_STATUS_KEY)
                .AddStaticText("Server Events: ", CairoFont.WhiteSmallText().WithFontSize(10), serverStatusBounds)
                .AddDynamicText(serverStatus, CairoFont.WhiteSmallText().WithFontSize(10), serverStatusBoundsDyn, SERVER_EVENT_STATUS_KEY)
