namespace VSCCI.GUI.Nodes
{
    ...
    public class MultiplyPureNode : ExecutableScriptNode
    {
        public static int INPUT_ONE_INDEX = 0;
        public static int INPUT_TWO_INDEX = 1;
        public static int OUTPUT_INDEX = 0;
        public MultiplyPureNode(ICoreClientAPI api, Matrix nodeTransform, ElementBounds bounds) : base("*", api, nodeTransform, bounds, true)
        {
        ...
        {
            return "This Multiplies \"First\" by \"Second\"";
        }
    }
}
