namespace VSCCI.GUI.Nodes
{
    ...
    public class AddPureNode : ExecutableScriptNode
    {
        public static int INPUT_ONE_INDEX = 0;
        public static int INPUT_TWO_INDEX = 1;
        public static int OUTPUT_INDEX = 0;
        public AddPureNode(ICoreClientAPI api, MatrixElementBounds bounds) : base("+", api, bounds, true)
        {
        ...
        {
            return "This adds \"First\" to \"Second\"";
        }
    }
}
