namespace VSCCI.GUI.Nodes
{
    ...
    {
        public GreaterThenPureNode(ICoreClientAPI api, MatrixElementBounds bounds) : base(">", api, bounds, true)
        {
        ...
        {
            return "This will set \"Result\" to true if \"First\" is greater then \"Second\"";
        }
    }
}
